...
$(function() {
  ...
  var clip = new ZeroClipboard(document.getElementsByClassName('languages'));

  $.jnotify.setup({ 'delay': 1000, 'fadeSpeed': 500 });

  clip.on('copy', function(event) {
    var name = clip.getData('text/plain');
    var el = '<i class="programming lang-' + name + '"></i>';
  ...
  function highlightElements(needle) {
    ...
    $(".languages li").each(function (index, el) {
